...
import uk.ac.wellcome.messaging.worker.{MonitoringProcessorFailure, Result, Successful}
...
trait MonitoringProcessor extends Monitoring with Logger {
  ...
  )(implicit monitoringClient: ProcessMonitoringClient, ec: ExecutionContext): Future[Result[Unit]] = {
